[![Version](https://img.shields.io/github/v/release/Open-CMSIS-Pack/STM32WBAxx_DFP)](https://github.com/Open-CMSIS-Pack/STM32WBAxx_DFP/releases/latest)
[![License: Apache-2.0](https://img.shields.io/badge/License-Apache--2.0-green?label)](https://github.com/Open-CMSIS-Pack/STM32WBAxx_DFP/blob/main/LICENSE)

# STM32WBAxx_DFP

This is the development repository for the **STMicroelectronics STM32WBA Series Device Family Pack (DFP)** - a CMSIS software pack that is designed to work with all compiler toolchains (Arm Compiler, GCC, IAR, LLVM). It is released as [CMSIS software pack](https://www.keil.arm.com/packs/stm32wbaxx_dfp-keil) and therefore accessible by CMSIS-Pack enabled software development tools.
...
:---------------------------|:--------------
[.github/workflows](https://github.com/Open-CMSIS-Pack/STM32WBAxx_DFP/tree/main/.github/workflows)  | [GitHub Actions](#github-actions) for creating the software pack.
[CMSIS/Debug](https://github.com/Open-CMSIS-Pack/STM32WBAxx_DFP/tree/main/CMSIS/Debug)              | Contains debug configuration scripts.
[CMSIS/Flash](https://github.com/Open-CMSIS-Pack/STM32WBAxx_DFP/tree/main/CMSIS/Flash)              | Contains flash algorithms.
[CMSIS/SVD](https://github.com/Open-CMSIS-Pack/STM32WBAxx_DFP/tree/main/CMSIS/SVD)                  | Contains SVD files for the devices.
[Templates](https://github.com/Open-CMSIS-Pack/STM32WBAxx_DFP/tree/main/Templates)                  | Device specific project templates to start new *csolution projects*.
...
This development repository can be used in a local directory and [mapped as software pack](https://open-cmsis-pack.github.io/cmsis-toolbox/build-tools/#install-a-repository) using for example `cpackget` with:
    ...
    cpackget add <path>/Keil.STM32WBAxx_DFP.pdsc
...
Please feel free to raise an [issue on GitHub](https://github.com/Open-CMSIS-Pack/STM32WBAxx_DFP/issues)
